...
# MODEL_PATH="runs/detect/ppe-6/weights/best.pt"
# CONFIDENCE = 0.5
# IMGSZ = 640
...
#         import traceback
#         traceback.print_exc()
model=YOLO("runs/detect/ppe-6/weights/best.pt")
model.predict(source="video/record_2026-05-30_15-43-25.avi",show=False,save=True,conf=0.35)